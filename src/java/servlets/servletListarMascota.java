 ...
 * @author Rav
 */
@WebServlet(name = "servletListarMascota", urlPatterns = {"/servletListarMascota"})
public class servletListarMascota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            sesion.setAttribute("s_mascotas", ListarMascotas(cmb_cliente));
            RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/listarMascota.jsp");
